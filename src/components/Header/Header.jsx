...
function Header({ title, subtitle }) {
    return (
        <div className="w-full h-auto flex flex-col sm:flex-row justify-between items-center bg-[rgba(255,255,255,0.21)] rounded-xl shadow-md relative">
            <div className="text-center sm:text-left w-11/12 sm:w-2/3 flex flex-col px-4 py-2 gap-2">
                <p className="text-5xl sm:text-6xl font-extrabold text-[#A60530]">{title}</p>
